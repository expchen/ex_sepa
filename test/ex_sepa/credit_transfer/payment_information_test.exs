defmodule ExSepa.CreditTransfer.PaymentInformationTest do
  use ExUnit.Case, async: true
  import ExSepa.Validation.CountryCodes, only: [get_eea_iban_country_codes: 0]
  import ExSepa.TestSupport.FactoryHelpers
  doctest ExSepa.CreditTransfer.PaymentInformation

  describe "ExSepa.CreditTransfer.PaymentInformation.new/1" do
    test "ok" do
    ...
    test "fail: requested_execution_date is in the past" do
      payment_id = example_payment_id()
    ...
    test "fail: requested_execution_date is not a date" do
      payment_id = example_payment_id()
      date = "text"
      debtor_name = example_person_name()
      debtor_iban = example_eea_iban()
    ...
    test "fail: debtor_iban invalid" do
      ...
      assert match?(
               {:error, _},
               ExSepa.CreditTransfer.PaymentInformation.new(%{
                 payment_id: payment_id,
                 requested_execution_date: date,
                 debtor_name: debtor_name,
                 debtor_iban: debtor_iban
