defmodule ExSepa.Schema.GroupHeaderTest do
  use ExUnit.Case, async: true
  doctest ExSepa.Schema.GroupHeader

  describe "ExSepa.Schema.GroupHeader.new()" do
    test ":ok" do
      assert ExSepa.Schema.GroupHeader.new(%{
    ...
    test "error: key missing initiating_party_name" do
      assert ExSepa.Schema.GroupHeader.new(%{
               msg_id: "Msg-ID-000100",
               party_name: "Gymnastics & sports club"
             }) ==
    ...
    test "ok: initiating_party_name german Fußbalclub" do
      assert ExSepa.Schema.GroupHeader.new(%{
               ...
               {:ok,
                %ExSepa.Schema.GroupHeader{
                  msg_id: "Msg-ID-000100",
                  initiating_party_name: "Fusbalclub"
                }}
    end
