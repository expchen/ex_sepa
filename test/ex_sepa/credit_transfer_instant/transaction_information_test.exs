defmodule ExSepa.CreditTransferInstant.TransactionInformationTest do
  use ExUnit.Case, async: true
  import ExSepa.TestSupport.FactoryHelpers
  doctest ExSepa.CreditTransferInstant.TransactionInformation

  describe "ExSepa.CreditTransferInstant.TransactionInformation.new/1" do
    test "ok" do
