defmodule ExSepa.CreditTransferInstant do
  ...
  The map has the following keys:
    ...
    * `:transaction_information` - OPTIONAL: A prebuilt list of `ExSepa.CreditTransferInstant.TransactionInformation` structs. This can be used as an alternative to calling `add_transaction_information/3` repeatedly.
  """
  ...
  def to_xml(%ExSepa.CreditTransferInstant{} = initiation) do
    initiation
    |> ExSepa.CreditTransferInstant.CustomerCreditTransferInitiationV09.to_xml()
